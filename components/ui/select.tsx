 ...
 * SelectTrigger
 * 
 * ANDROID FIX: Changed base width from w-fit to w-full and added min-w-0
 * to prevent dropdown-induced parent reflow on Android Chrome.
 * Components that need w-fit can override via className.
 */
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // ANDROID FIX: w-full + min-w-0 prevents shrink during dropdown animation
