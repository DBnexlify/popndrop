...
export const metadata = {
  ...
  description: "Browse our bounce houses and inflatables for rent in Ocala, FL and Marion County. Water slides, themed bounce houses, and party inflatables.",
};

// Revalidate every 60 seconds (or on-demand with revalidatePath)
...
// ============================================
// RENTAL CARD COMPONENT (Server part)
// ============================================
function RentalCard({
  product,
  priority = false,
  ...
  return (
    <RentalCardClient product={product} priority={priority}>
