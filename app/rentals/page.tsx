...
export default function RentalsPage() {
  return (
    <main className="mx-auto max-w-5xl px-4 pb-24 pt-8 sm:pt-12">
      ...
      <section className="mt-10 rounded-3xl border bg-background/60 p-6 backdrop-blur-xl">
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="space-y-1">
            <div className="text-sm font-semibold">Delivery and setup</div>
            <div className="text-sm opacity-80">We deliver, set up, and pick up within our service area.</div>
          </div>
          <div className="space-y-1">
            <div className="text-sm font-semibold">Deposit to hold</div>
            <div className="text-sm opacity-80">Reserve your date with a deposit during booking.</div>
          </div>
          <div className="space-y-1">
            <div className="text-sm font-semibold">Fast confirmation</div>
            <div className="text-sm opacity-80">We confirm quickly so you can relax.</div>
          </div>
        </div>
      </section>
    </main>
